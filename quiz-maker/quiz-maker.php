 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '6.7.1.32' );
define( 'AYS_QUIZ_VERSION', '6.7.1.32' );
         ...
         <div class="ays-notice-banner">
            <div class="navigation-bar">
                <div id="navigation-container">
                    ...
                    <ul id="menu">
                        <li class="modile-ddmenu-lg"><a class="ays-btn" href="https://quiz-plugin.com/pricing/?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=quiz-maker-top-banner-pricing-link-<?php echo esc_attr( AYS_QUIZ_UTM_VERSION ); ?>" target="_blank"><?php echo esc_html__( "Pricing", 'quiz-maker' ); ?></a></li>
                        ...
                        <li class="modile-ddmenu-md">
                            ...
                            <ul class="ddmenu" data-expanded="false">
                                <li><a class="ays-btn" href="https://quiz-plugin.com/pricing/?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=quiz-maker-top-banner-pricing-link-<?php echo esc_attr( AYS_QUIZ_UTM_VERSION ); ?>" target="_blank"><?php echo esc_html__( "Pricing", 'quiz-maker' ); ?></a></li>

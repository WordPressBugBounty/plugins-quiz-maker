...
class Quiz_Maker_Settings_Actions {
    ...
    public function store_data(){
        ...
        if( isset($_REQUEST["settings_action"]) && wp_verify_nonce( sanitize_text_field( $_REQUEST["settings_action"] ), 'settings_action' ) ){
            ...
            $already_passed_quiz_message_text   = (isset($_REQUEST['ays_already_passed_quiz_message_text']) && $_REQUEST['ays_already_passed_quiz_message_text'] != '') ? sanitize_text_field( stripslashes( $_REQUEST['ays_already_passed_quiz_message_text'] ) ) : 'You have already passed this quiz.';
            ...
            $default_texts = array(
                ...
                'already_passed_quiz_message_text'      => $already_passed_quiz_message_text,
            );
            // Default texts | End

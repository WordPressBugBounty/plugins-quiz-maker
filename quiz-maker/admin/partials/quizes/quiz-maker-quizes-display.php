...
<div class="wrap ays-quiz-list-table ays_quizzes_list_table">
    ...
    <div class="ays-quiz-create-survey-video-box" style="margin: 0px auto 30px;">
        ...
        <div class="ays_quiz_small_hint_text_for_message_variables" style="text-align: center;">
            <?php echo esc_html__( 'Note that this video will disappear once you created 4 quizzes.', 'quiz-maker' ); ?>
        </div>
    </div>
    <?php else: ?>
        ...
        <div class="ays-modal-content fadeInDown" id="ays-quick-modal-content">
            ...
            <div class="ays-modal-body">
                <form method="post" id="ays_quick_popup">
                            ...
                            <div class="col-sm-9 ays_toggle_target ays-quiz-tab-content ays_divider_left display_none">
                                ...
                                <div class="ays-quiz-accordion-options-main-container" data-collapsed="false">
                                    ...
                                    <div class="ays-quiz-accordion-options-box">
                                        ...
                                        <div class="form-group row ays_toggle_parent">
                                            <div class="col-sm-4">
                                                <label for="ays_quick_quiz_enable_password">
                                                    <?php echo esc_html__('Password for passing quiz', 'quiz-maker'); ?>
                                                </label>
                                            </div>
                                            <div class="col-sm-1">
                                                <input type="checkbox" class="ays-enable-timer1 ays_toggle_checkbox" id="ays_quick_quiz_enable_password" name="ays_quick_quiz_enable_password" value="on" />
                                            </div>
                                            <div class="col-sm-7 ays_toggle_target ays_divider_left display_none">
                                                <div class="form-group row">
                                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_content_mobile_max_width'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <div>
                                                                <input type="number" class="ays-text-input ays-text-input-short" id='ays_quick_quiz_content_mobile_max_width' name='ays_quick_quiz_content_mobile_max_width' value="90"/>
                                                            </div>
                                                            <div class="ays_quiz_dropdown_max_width">
                                                                <input type="text" value="%" class='ays-quiz-form-hint-for-size' disabled>
                                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_quest_explanation_mobile_text_decoration'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <select class="ays-text-input ays-text-input-short" id="ays_quick_quiz_quest_explanation_mobile_text_decoration" name="ays_quick_quiz_quest_explanation_mobile_text_decoration">
                                                                <option value="none" selected><?php echo esc_html__('None','quiz-maker'); ?></option>
                                                                <option value="overline"><?php echo esc_html__('Overline','quiz-maker'); ?></option>
                                                                <option value="line-through"><?php echo esc_html__('Line through','quiz-maker'); ?></option>
                                                                <option value="underline"><?php echo esc_html__('Underline','quiz-maker'); ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_quest_explanation_mobile_letter_spacing'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <div>
                                                                <input type="number" class="ays-text-input ays-text-input-short" id="ays_quick_quiz_quest_explanation_mobile_letter_spacing" name="ays_quick_quiz_quest_explanation_mobile_letter_spacing" value="0"/>
                                                            </div>
                                                            <div class="ays_quiz_dropdown_max_width ays-display-flex" style="align-items: flex-start;">
                                                                <input type="text" value="px" class='ays-quiz-form-hint-for-size' disabled>
                                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_quest_explanation_mobile_font_weight'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <select class="ays-text-input ays-text-input-short" id="ays_quick_quiz_quest_explanation_mobile_font_weight" name="ays_quick_quiz_quest_explanation_mobile_font_weight">
                                                                <option value="normal" selected>
                                                                    <?php echo esc_html__('Normal','quiz-maker'); ?>
                                                                </option>
                                                                <option value="lighter">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_right_answer_mobile_text_transform'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <select class="ays-text-input ays-text-input-short" id="ays_quick_quiz_right_answer_mobile_text_transform" name="ays_quick_quiz_right_answer_mobile_text_transform">
                                                                <option value="none" selected>
                                                                    <?php echo esc_html__('None','quiz-maker'); ?>
                                                                </option>
                                                                <option value="capitalize">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_right_answers_mobile_text_decoration'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <select class="ays-text-input ays-text-input-short" id="ays_quick_quiz_right_answers_mobile_text_decoration" name="ays_quick_quiz_right_answers_mobile_text_decoration">
                                                                <option value="none" selected>
                                                                    <?php echo esc_html__('None','quiz-maker'); ?>
                                                                </option>
                                                                <option value="overline">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_right_answers_mobile_letter_spacing'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <div>
                                                                <input type="number" class="ays-text-input ays-text-input-short" id="ays_quick_quiz_right_answers_mobile_letter_spacing" name="ays_quick_quiz_right_answers_mobile_letter_spacing" value="0" />
                                                            </div>
                                                            <div class="ays_quiz_dropdown_max_width ays-display-flex" style="align-items: flex-start;">
                                                                <input type="text" value="px" class='ays-quiz-form-hint-for-size' disabled>
                                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_wrong_answer_mobile_text_transform'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <select class="ays-text-input ays-text-input-short" id="ays_quick_quiz_wrong_answer_mobile_text_transform" name="ays_quick_quiz_wrong_answer_mobile_text_transform">
                                                                <option value="none" selected>
                                                                    <?php echo esc_html__('None','quiz-maker'); ?>
                                                                </option>
                                                                <option value="capitalize">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_wrong_answers_mobile_letter_spacing'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <div>
                                                                <input type="number" class="ays-text-input ays-text-input-short" id="ays_quick_quiz_wrong_answers_mobile_letter_spacing" name="ays_quick_quiz_wrong_answers_mobile_letter_spacing" value="0" />
                                                            </div>
                                                            <div class="ays_quiz_dropdown_max_width ays-display-flex" style="align-items: flex-start;">
                                                                <input type="text" value="px" class='ays-quiz-form-hint-for-size' disabled>
                                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div style="margin-bottom: 10px;">
                                                            <label for='ays_quick_quiz_wrong_answers_mobile_font_weight'>
                                                                <?php echo esc_html__('On mobile', 'quiz-maker'); ?>
                                                            </label>
                                                        </div>
                                                        <div class="ays_quiz_display_flex_width">
                                                            <select class="ays-text-input ays-text-input-short" id="ays_quick_quiz_wrong_answers_mobile_font_weight" name="ays_quick_quiz_wrong_answers_mobile_font_weight">
                                                                <option value="normal" selected>
                                                                    <?php echo esc_html__('Normal','quiz-maker'); ?>
                                                                </option>
                                                                <option value="lighter">
                    ...
                    <input type="hidden" id="ays_quiz_ajax_quick_quiz_nonce" name="ays_quiz_ajax_quick_quiz_nonce" value="<?php echo esc_attr( $quick_quiz_plugin_nonce ); ?>">
                </form>
            </div>
        </div>
    </div>

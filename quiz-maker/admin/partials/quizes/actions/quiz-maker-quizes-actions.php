...
$tab_docs = array(
    'tab1' => array(
        ...
        'text' => __('How to Create a Quiz?', 'quiz-maker'),
    ),
    'tab2' => array(
...
$quiz_custom_post_id = (isset($quiz['custom_post_id']) && absint($quiz['custom_post_id']) > 0) ? absint($quiz['custom_post_id']) : 0;
$quiz_custom_post_permalink = ($quiz_custom_post_id > 0) ? get_permalink($quiz_custom_post_id) : '';
$quiz_preview_url = !empty($quiz_custom_post_permalink) ? add_query_arg('preview', 'true', $quiz_custom_post_permalink) : '';
$quiz_shortcode = (!empty($id)) ? "[ays_quiz id='" . absint($id) . "']" : '';
...
$submit_redirect_url = isset($options['submit_redirect_url']) ? esc_url($options['submit_redirect_url']) : '';
...
$exit_redirect_url = isset($options['exit_redirect_url']) && $options['exit_redirect_url'] != '' ? esc_url($options['exit_redirect_url']) : '';
...
<div class="wrap ays-quiz-dashboard-main-wrap">
    <div class="container-fluid">
        <div id="ays-quiz-tab-doc-link" class="ays-quiz-heading-box" style="margin-bottom: 40px;">
            <div class="ays-quiz-wordpress-user-manual-box">
                ...
                <a class="ays-quiz-doc-link" href="<?php echo isset($tab_docs[$ays_quiz_tab]['link']) ? esc_url($tab_docs[$ays_quiz_tab]['link']) : 'https://quiz-plugin.com/docs/how-to-create-a-quiz/'; ?>" target="_blank">
                    ...
                    <span style="margin-left: 3px;text-decoration: underline;"><?php echo isset($tab_docs[$ays_quiz_tab]['text']) ? esc_html($tab_docs[$ays_quiz_tab]['text']) : esc_html__('How to Create a Quiz?', 'quiz-maker'); ?></span>
                </a>
            </div>
        </div>
        <h1 class="wp-heading-inline" style="margin-top: 0;margin-bottom: 10px;">
            <?php
        ...
        <form class="ays-quiz-category-form ays-quiz-main-form" id="ays-quiz-category-form" method="post">
            ...
            <div>
                <div class="ays-quiz-subtitle-main-box ays-quiz-edit-page-subtitle-container">
                    ...
                    <div class="ays-quiz-open-quizzes-list">
                        <svg class="ays-quiz-accordion-arrow ays-quiz-accordion-arrow-down" version="1.2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" overflow="visible" preserveAspectRatio="none" viewBox="0 0 24 24" width="32" height="32" style="transform: rotate(90deg);">
                            <g>
                    ...
                    <div class="ays-top-menu">
                        <div class="nav-tab-wrapper ays-top-tab-wrapper">
                            ...
                            <a href="#tab9" data-tab="tab9" class="nav-tab <?php echo ($ays_quiz_tab == 'tab9') ? 'nav-tab-active' : ''; ?>">
                                <?php echo esc_html__("Publish", 'quiz-maker');?>
                            </a>
                        </div>
                    </div>              
            ...
            <div id="tab1" class="ays-quiz-separate-tab-content ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab1') ? 'ays-quiz-tab-content-active' : ''; ?>">
                <div class="ays-quiz-separate-tab ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('Start page detials','quiz-maker'); ?></p>
                    </div>
                ...
                <div class="ays-quiz-separate-tab ays-quiz-second-separate-tab ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-heading-box" style="padding-top: 30px; margin: 0;">
                        <div class="ays-quiz-wordpress-user-manual-box">
                            <a href="https://quiz-plugin.com/docs/creating-questions/" target="_blank">
                                <i class="ays_fa ays_fa_file_text" ></i> 
                                <span style="margin-left: 3px;text-decoration: underline;"><?php echo esc_html__("How to Create a Question?", "quiz-maker"); ?></span>
                            </a>
                        </div>
                    </div>
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('Questions','quiz-maker'); ?></p>
                        <a class="ays_help" style="margin-left:5px; font-size:15px;" data-placement="bottom" data-toggle="tooltip" data-html="true" title="<?php echo esc_attr("<p style='margin:0;text-indent:7px;'>").esc_attr(__('For inserting questions to the quiz you need to make questions first from the “Questions page” in the left navbar. After popup’s opening, you can filter and select your prepared questions for this quiz.', 'quiz-maker')).esc_attr("</p><p style='margin:0;text-indent:7px;'>").esc_attr(__('The ordering of the questions will be the same as you chose. Also, you can reorder them after selection. There are no limitations for questions quantity.', 'quiz-maker')).esc_attr("</p>"); ?>">
                            <i class="ays_fa ays_fa_info_circle"></i>
                        </a>
                    </div>
                    <hr class="ays-quiz-bolder-hr"/>
            ...
            <div id="tab3" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab3') ? 'ays-quiz-tab-content-active' : ''; ?>">
                    ...
                    <div class="ays-quiz-accordion-options-box">
                            ...
                            <div class="col-sm-7 ays_toggle_target ays_divider_left  <?php echo ( $enable_timer ) ? '' : 'display_none'; ?>">
                                <div class="ays-quiz-timer-container" id="ays-quiz-timer-container">
                                    ...
                                    <div class="form-group row ays-quiz-result-message-vars-parent">
                                        ...
                                        <div class="col-sm-9">
                                            <?php
                                                echo wp_kses($quiz_message_vars_timer_html, $quiz_allowed_html);
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="ays_questions_count" id="ays_questions_count"
                                               ...
                                               value="<?php echo (isset($options['questions_count'])) ? intval($options['questions_count']) : '' ?>">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            ...
                            <div class="col-sm-7 ays_toggle_target ays_divider_left active_date <?php echo $active_date_check ? '' : 'display_none' ?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label class="form-check-label" for="ays-deactive"> <?php echo esc_html__('End date:', 'quiz-maker'); ?> </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                ...
                                <div class="form-group row ays-quiz-result-message-vars-parent">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="editor">
                                            <?php
                                            echo wp_kses($quiz_message_vars_schedule_pre_start_message_html, $quiz_allowed_html);
                                ...
                                <div class="pro_features pro_features_popup">
                                    <div class="pro-features-popup-conteiner">
                                        ...
                                        <div class="pro-features-popup-content" data-link="https://youtu.be/pf-HSumxP3Y">
                                            <p>
                                                <?php echo wp_kses_post( sprintf( __("Add a navigation bar at the top of your Quiz and allow the users to %s move into the questions easily. %s Give them to pass the hard questions and get back to it whenever they will have the answer.", 'quiz-maker'),
                                                    "<strong>",
                                                    "</strong>"
                                                ) ); ?>
                                            </p>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_show_answers_numbering">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Assign numbering to each answer in ascending sequential order. Choose your preferred type from the list.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-8">
                                <select class="ays-text-input ays-text-input-short" name="ays_show_answers_numbering" id="ays_show_answers_numbering">
                                    <option <?php echo $show_answers_numbering == "none" ? "selected" : ""; ?> value="none"><?php echo esc_html__( "None", 'quiz-maker'); ?></option>
                                    <option <?php echo $show_answers_numbering == "1." ? "selected" : ""; ?> value="1."><?php echo esc_html__( "1.", 'quiz-maker'); ?></option>
                                    <option <?php echo $show_answers_numbering == "1)" ? "selected" : ""; ?> value="1)"><?php echo esc_html__( "1)", 'quiz-maker'); ?></option>
                                    <option <?php echo $show_answers_numbering == "A." ? "selected" : ""; ?> value="A."><?php echo esc_html__( "A.", 'quiz-maker'); ?></option>
                                    <option <?php echo $show_answers_numbering == "A)" ? "selected" : ""; ?> value="A)"><?php echo esc_html__( "A)", 'quiz-maker'); ?></option>
                                    <option <?php echo $show_answers_numbering == "a." ? "selected" : ""; ?> value="a."><?php echo esc_html__( "a.", 'quiz-maker'); ?></option>
                                    <option <?php echo $show_answers_numbering == "a)" ? "selected" : ""; ?> value="a)"><?php echo esc_html__( "a)", 'quiz-maker'); ?></option>
                                </select>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label>
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Specify where to display right/wrong answers. Note that the “Show correct answers” option should be enabled. In order to make this option work, you need to add the corresponding texts from the Edit page of the particular question.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                ...
                <div class="ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('Start Page','quiz-maker')?></p>
                    </div>
                    <hr class="ays-quiz-bolder-hr"/>
                    <div class="ays-quiz-accordion-options-box">
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label>
                                    <?php echo esc_html__('Show quiz head information','quiz-maker')?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Enable to show the quiz title and description in the start page of the quiz(in the front-end).','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_enable_pass_count">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show how many users passed the quiz. It will be shown at the bottom of  the start page of the quiz','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_show_category">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show quiz category in quiz start page','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_enable_quiz_category_description">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the quiz category description on the Quiz Start page.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_enable_rate_avg">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the average rate of the quiz. It will be shown at the bottom of the start page of the quiz.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_show_author">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show quiz author in quiz start page','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_show_create_date">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show creation date in quiz start page','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_quiz_change_creation_date">
                                    <?php echo esc_html__('Change current quiz creation date','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Change the quiz creation date to your preferred date.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-8">
                                <div class="input-group mb-3">
                                    <input type="text" class="ays-text-input ays-text-input-short ays-quiz-date-create" id="ays_quiz_change_creation_date" name="ays_quiz_change_creation_date" value="<?php echo esc_attr($change_creation_date); ?>" placeholder="<?php echo esc_attr( current_time( 'mysql' ) ); ?>">
                                    <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_enable_autostart">
                                            <?php echo esc_html__('Enable autostart','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('If you enable this option, your quiz will start automatically after the page is fully loaded. Note, that this option is designed for 1 quiz in a page. If you put multiple quizzes in a page, only the one located at the top will autostart.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                ...
                <div class="ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('Button Settings','quiz-maker')?></p>
                    </div>
                    <hr class="ays-quiz-bolder-hr" />
                    <div class="ays-quiz-accordion-options-box">
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_next_button">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('User can change the question forward manually. If you want to make the questions required just disable this option.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_previous_button">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('User can change the question backward manually','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4">
                                <label for="ays_enable_early_finish">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Allow user to finish the quiz early.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_enable_early_finsh_comfirm_box">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('If the checkbox is ticked and the Finish button is enabled too, then when the user clicks on the Finish button, the confirmation box will be displayed. It will ask `Do you want to finish the quiz? Are you sure? `.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_clear_answer">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Allow user to clear the selected answer. Button will not be displayed if Show correct answers option is enabled.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_enter_key">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('This option allows users to go to the next question by pressing Enter key. It is working with the following question types only: Text, Short Text, Number.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4">
                                <label for="ays_enable_arrows">
                                    <?php echo esc_html__('Use arrows instead of buttons','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Buttons will be replaced to icons.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                                <p class="ays_quiz_small_hint_text_for_message_variables">
                                    <span><?php echo esc_html__( "Note" , 'quiz-maker' ); ?></span>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Note that if the background color and the button text color are the same, the arrows will not be visible.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_quiz_enable_custom_texts_for_buttons">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Enable this option and write your desired custom texts for buttons, instead of the default ones. Note: If this option is disabled, the Buttons Texts will be taken from the General Settings page > Buttons Texts tab.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                ...
                <div class="ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('Advanced Settings','quiz-maker')?></p>
                    </div>
                    <hr class="ays-quiz-bolder-hr">
                    <div class="ays-quiz-accordion-options-box">
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_audio_autoplay">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('If there is audio in the question, it will automatically turn on.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_enable_percent_view_option">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the progress bar by percentage.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_rtl_direction">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Enable Right to Left direction for the text. This option is intended for the Arabic language.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_quiz_create_author">
                                    <?php echo esc_html__('Change the author of the current quiz','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('You can change the author who created the current quiz to your preferred one. You need to write the User ID here. Note, that in case you write an ID, by which there are no users found, the changes will not be applied and the previous author will remain the same.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-8">
                                <select class="ays-text-input ays-text-input-short select2-container-200-width" id='ays_quiz_create_author'name='ays_quiz_create_author'>
                                    ...
                                    <?php
                                        echo "<option value='" . esc_attr($ays_quiz_create_author_data['ID']) . "' selected>" . esc_html( $ays_quiz_create_author_data['display_name'] ) . "</option>";
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_questions_counter">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the number of the current question and the total amount of the question in the quiz. It will be shown on the right top corner of the quiz container. Example: 3/7.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_quiz_enable_question_image_zoom">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('By enabling this option, the users can zoom the question images and open them in the large size on the Front-end.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_leave_page">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show confirmation popup if user tries to refresh or leave the page during the quiz taking process.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_see_result_confirm_box">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('When this option is ticked, a confirmation box will appear after the user clicks the See Result button at the end of the quiz.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_enable_rw_asnwers_sounds">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('This option will work only when Enable Show correct answers option is enabled and sounds are selected from General options page.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-7 ays_toggle_target ays_divider_left" style="<?php echo $enable_rw_asnwers_sounds ? '' : 'display:none;' ?>">
                                ...
                                <blockquote class=""><?php echo esc_html__('Sounds are selected. For change sounds go to', 'quiz-maker'); ?> <a href="?page=quiz-maker-settings"><?php echo esc_html__('General options', 'quiz-maker'); ?></a> <?php echo esc_html__('page', 'quiz-maker'); ?></blockquote>
                                <?php else: ?>
                                <blockquote class=""><?php echo esc_html__('Sounds are not selected. For selecting sounds go to', 'quiz-maker'); ?> <a href="?page=quiz-maker-settings"><?php echo esc_html__('General options', 'quiz-maker'); ?></a> <?php echo esc_html__('page', 'quiz-maker'); ?></blockquote>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_enable_bg_music">
                                    <?php echo esc_html__('Enable Background music','quiz-maker')?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Background music will play while passing the quiz. Upload your own audio file for the quiz.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-7 ays_toggle_target ays_divider_left" style="<?php echo $enable_bg_music ? '' : 'display:none;' ?>">
                                <div class="ays-bg-music-container">
                                    <a class="add-quiz-bg-music" href="javascript:void(0);"><?php echo esc_html__("Select music", 'quiz-maker'); ?></a>
                                    <audio controls src="<?php echo esc_url($quiz_bg_music); ?>"></esc_html__>
                                    <input type="hidden" name="ays_quiz_bg_music" class="ays_quiz_bg_music" value="<?php echo esc_url($quiz_bg_music); ?>">
                                </div>
                            </div>
                        ...
                        <div class="form-group row" style="margin:0px;">
                            <div class="col-sm-12 only_pro" style="padding:10px 0 0 10px;">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label>
                                            <?php echo esc_html__('Embed code','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Copy the iframe and embed it on another/your website. Paste the iframe like HTML on your desired WP Editor. By this, the quiz will be opened on that particular page.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_allow_exporting_quizzes">
                                            <?php echo esc_html__('Export Quiz as PDF','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('After ticking this option the Users field will be activated. You will be able to choose whom you want to give the permission to export the Quiz in the PDF file format. The Export to PDF button will be displayed on the front-end.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
            ...
            <div id="tab4" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab4') ? 'ays-quiz-tab-content-active' : ''; ?>">
                    ...
                    <div class="ays-quiz-accordion-options-box">
                                ...
                                <div class="ays-quiz-heading-box ays-quiz-unset-float ays-quiz-unset-margin">
                                    <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                        <a href="https://www.youtube.com/watch?v=DHolVT3O0Zk" target="_blank">
                                            <?php echo esc_html__("How to create scored quiz - video", 'quiz-maker'); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_calculate_score">
                                            <?php echo esc_html__('Calculate the score','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Calculate the score of results by the selected method.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8 pro_features_parent ays-quiz-pro-features-parent-box-display-flex">
                                        <label class="ays_quiz_loader">
                                            ...
                                            <span><?php echo esc_html__( "By correctness", 'quiz-maker' ); ?></span>
                                        </label>
                                        <label class="ays_quiz_loader only_pro ays-pro-features-v2-main-box">
                                            ...
                                            <div class="pro_features pro_features_popup" style="align-items: flex-end;justify-content: flex-end;">
                                                <div class="pro-features-popup-conteiner">
                                                    <div class="pro-features-popup-title">
                                                        <?php echo esc_html__("Calculate the score option", 'quiz-maker'); ?>
                                                    </div>
                                                    <div class="pro-features-popup-content" data-link="https://youtu.be/2OYoqJtsjoc">
                                                        <p>
                                                            <?php echo wp_kses_post( sprintf( __("The option gives you the possibility to choose the most appropriate calculation system for your quiz. You can set the calculation method either %s by Correctness or by Weight/Points. %s", 'quiz-maker'),
                                                                '<strong>',
                                                                '</strong>'
                                                            ) ); ?>
                                                        </p>
                                                        <p>
                                                            <?php echo esc_html__("You just need to configure the calculation system depending on the type of quiz you want to create.", 'quiz-maker'); ?>
                                                        </p>
                                                        <div>
                                            ...
                                            <span><?php echo esc_html__( "By weight / points", 'quiz-maker' ); ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row ays-quiz-result-message-vars-parent">
                            <div class="col-sm-4">
                                <label for="ays_result_text">
                                    <?php echo esc_html__('Result message','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('The message will be displayed after submitting the quiz. You can use Variables (General Settings) to insert user data here. If you want to show results with points or with the number of correct answers, you need to use correspondent variables and enable the “Hide score” option.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                                <p class="ays_quiz_small_hint_text_for_message_variables">
                                    <span><?php echo esc_html__( "To see all Message Variables " , 'quiz-maker' ); ?></span>
                                    <a href="?page=quiz-maker-settings&ays_quiz_tab=tab4" target="_blank"><?php echo esc_html__( "click here" , 'quiz-maker' ); ?></a>
                                </p>
                            </div>
                            <div class="col-sm-8">
                                <?php
                                echo wp_kses($quiz_message_vars_html, $quiz_allowed_html);
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                         <input type="number" class="ays-text-input" id='ays-pass-score' name='ays_pass_score' value="<?php echo intval($pass_score); ?>"/>
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group row ays-quiz-result-message-vars-parent">
                                    <div class="col-sm-4">
                                        <label class="form-check-label" for="ays_pass_score_message">
                                            <?php echo esc_html__("Quiz pass message", 'quiz-maker') ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('The message in the case of the user passes the quiz','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                        <p class="ays_quiz_small_hint_text_for_message_variables">
                                    ...
                                    <div class="col-sm-8">
                                        <?php echo wp_kses($quiz_message_vars_html, $quiz_allowed_html); ?>
                                        <div class="editor">
                                            <?php
                                ...
                                <div class="form-group row ays-quiz-result-message-vars-parent">
                                    <div class="col-sm-4">
                                        <label class="form-check-label" for="ays_fail_score_message">
                                            <?php echo esc_html__("Quiz fail message", 'quiz-maker') ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('The message in the case of the user fails the quiz','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                        <br>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label>
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('How to display score of result','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-8">
                                <label class="ays_quiz_loader">
                                    ...
                                    <span><?php echo esc_html__( "By percentage", 'quiz-maker' ); ?></span>
                                </label>
                                <label class="ays_quiz_loader">
                                    ...
                                    <span><?php echo esc_html__( "By correct answers count", 'quiz-maker' ); ?></span>
                                </label>
                            </div>
                        </div><!-- Display score -->
                        <hr/>
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_hide_score">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Disable to show the user score with percentage on the finish page. If you want to show points or correct answers count, you need to tick this option and use Variables (General Settings) in the “Text for showing after quiz completion” option.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4">
                                <label for="ays_redirect_after_submit">
                                    <?php echo esc_html__('Redirect after submission','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Redirect to custom URL after user submit the form.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_submit_redirect_url">
                                            <?php echo esc_html__('Redirect URL','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('The URL for redirecting after the user submits the form.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="ays_submit_redirect_url"
                                            ...
                                            value="<?php echo esc_url($submit_redirect_url); ?>"/>
                                    </div>
                                </div>
                                <div class="form-group row" style="margin:0px;">
                                    <div class="col-sm-12 only_pro" style="padding:10px 0 0 10px;">
                                        ...
                                        <span style="display:block; pointer-events: none;" class="ays_quiz_small_hint_text">
                                            <?php echo 
                                                wp_kses_post( sprintf( __("Add '%s' phrase at the end of the url.%s Use %s line in your code, by replacing the 'if_false' with a value that will be returned in case something goes wrong.", 'quiz-maker'),
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_submit_redirect_delay">
                                            <?php echo esc_html__('Redirect delay (sec)', 'quiz-maker'); ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('The redirection delay in seconds after the user submits the form. Value should be greater than 0.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="number" class="ays-text-input" id="ays_submit_redirect_delay"
                                            ...
                                            value="<?php echo intval($submit_redirect_delay); ?>"/>
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_message_before_redirect_timer">
                                            <?php echo esc_html__('Message before redirect timer','quiz-maker'); ?>
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="ays_quiz_message_before_redirect_timer" name="ays_quiz_message_before_redirect_timer" value="<?php echo esc_attr($quiz_message_before_redirect_timer); ?>"/>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('Completion Actions','quiz-maker'); ?></p>
                    </div>
                    <hr class="ays-quiz-bolder-hr"/>
                    <div class="ays-quiz-accordion-options-box">
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label>
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Choose the design of the loader on the finish page after submitting. It will inherit the Quiz Text color from the Styles tab.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-8 ays_toggle_loader_parent">
                                ...
                                <label class="ays_quiz_loader">
                                    ...
                                    <div class="ays_quiz_loader_text">
                                        <?php echo esc_html__( "Text" , 'quiz-maker' ); ?>
                                    </div>
                                    <div class="ays_toggle_loader_target <?php echo ($quiz_loader == 'text') ? '' : 'display_none' ?>" data-type="text">
                                        <input type="text" class="ays-text-input" data-type="text" id="ays_quiz_loader_text_value" name="ays_quiz_loader_text_value" value="<?php echo esc_attr($quiz_loader_text_value); ?>">
                                    </div>
                                </label>
                                <label class="ays_quiz_loader">
                                    ...
                                    <div class="ays_quiz_loader_custom_gif">
                                        <?php echo esc_html__( "Gif" , 'quiz-maker' ); ?>
                                    </div>
                                    <div class="ays_toggle_loader_target ays-image-wrap <?php echo ($quiz_loader == 'custom_gif') ? '' : 'display_none' ?>" data-type="gif">
                                        <a href="javascript:void(0)" style="<?php echo ($quiz_loader_custom_gif == '') ? 'display:inline-block' : 'display:none'; ?>" class="ays-add-image add_quiz_loader_custom_gif"><?php echo esc_html__('Add Gif', 'quiz-maker'); ?></a>
                                        <input type="hidden" class="ays-image-path" id="ays_quiz_loader_custom_gif" name="ays_quiz_loader_custom_gif" value="<?php echo esc_url($quiz_loader_custom_gif); ?>"/>
                                        <div class="ays-image-container" style="<?php echo ($quiz_loader_custom_gif == '') ? 'display:none' : 'display:block'; ?>">
                                            ...
                                            <img loading="lazy"  src="<?php echo esc_url($quiz_loader_custom_gif); ?>" class="img_quiz_loader_custom_gif"/>
                                        </div>
                                    </div>
                                    <div class="ays_toggle_loader_target ays_gif_loader_width_container <?php echo ($quiz_loader == 'custom_gif') ? 'display_flex' : 'display_none'; ?>" data-type="gif" style="margin: 10px;">
                                        <div>
                                            <label for='ays_quiz_loader_custom_gif_width'>
                                                <?php echo esc_html__('Width (px)', 'quiz-maker'); ?>
                                                <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Custom Gif width in pixels. It accepts only numeric values.','quiz-maker'); ?>">
                                                    <i class="ays_fa ays_fa_info_circle"></i>
                                                </a>
                                            </label>
                                        </div>
                                        <div style="margin-left: 5px;">
                                            <input type="number" class="ays-text-input" id='ays_quiz_loader_custom_gif_width' name='ays_quiz_loader_custom_gif_width' value="<?php echo intval( $quiz_loader_custom_gif_width ); ?>"/>
                                        </div>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4">
                                <label for="ays_enable_restart_button">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the restart button at the end of the quiz for restarting the quiz and pass it again.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4">
                                <label for="ays_questions_result_option">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show all questions with right and wrong answers after quiz','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_hide_correct_answers">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('After enabling this option, the user whose chosen answer to the question is wrong will not see the right one.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_show_wrong_answers_first">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Tick the checkbox if you want to show the wrongly answered questions by the particular user in the first place on the result page.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_show_only_wrong_answers">
                                            <?php echo esc_html__('Show only wrong answers','quiz-maker'); ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Tick this option if you want to see only the wrong answers on the quiz results page.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row ays_toggle_parent">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_enable_results_toggle">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('If you enable this option, a toggle will be displayed by which you can show/hide the results of the quiz questions on the Front-end.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_enable_bar_option">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show score via progressbar','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4" style="padding-right: 0px;">
                                <label for="ays_enable_quiz_rate">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Comment and rate the quiz with up to 5 stars at the end of the quiz.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-7 ays_hidden" style="border-left: 1px solid #ededed; <?php echo ($enable_quiz_rate == 'on') ? '' : 'display:none;' ?>">
                                <div class="form-group row">
                                    <div class="col-sm-4" style="padding-right: 0px;">
                                        <label for="ays_enable_rate_comments">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the last 5 reviews after rating the quiz.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_make_responses_anonymous">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Collect anonymous responses no matter the quiz taker is a logged-in user or guest.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_enable_user_cհoosing_anonymous_assessment">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('By ticking this option, the users can choose to leave a rating anonymously.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_make_all_review_link">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Tick the option, and the quiz taker will have the opportunity to see all feedbacks written by others.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_review_enable_comment_field">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('By disabling this option, the comment field will be hidden and you can only rate with stars. This option is enabled by default.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="ays_quiz_review_placeholder_text" name="ays_quiz_review_placeholder_text" value="<?php echo esc_attr($quiz_review_placeholder_text); ?>"/>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row ays-quiz-result-message-vars-parent">
                                    <div class="col-sm-4" style="padding-right: 0px;">
                                        <label for="ays_rate_form_title">
                                            <?php echo esc_html__('Rating form title','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Text which will notify user that he can submit a feedback','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <?php
                                        echo wp_kses($quiz_message_vars_rating_form_title_html, $quiz_allowed_html);
                                ...
                                <div class="form-group row ays-quiz-result-message-vars-parent">
                                    <div class="col-sm-4" style="padding-right: 0px;">
                                        <label for="ays_quiz_review_thank_you_message">
                                            <?php echo esc_html__('Thank you message','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('By enabling this option, the text written in the editor is displayed when the user writes a review for the quiz.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <?php
                                        echo wp_kses($quiz_message_vars_review_thank_you_message_html, $quiz_allowed_html);
                ...
                <div class="ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('Advanced','quiz-maker'); ?></p>
                    </div>
                    <hr class="ays-quiz-bolder-hr"/>
                    <div class="ays-quiz-accordion-options-box">
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-4">
                                <label for="ays_enable_exit_button">
                                    <?php echo esc_html__('Enable Exit button','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Exit button will be displayed in the finish page and must redirect the user to a custom URL.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_exit_redirect_url">
                                            <?php echo esc_html__('Redirect URL','quiz-maker'); ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('The custom URL address for EXIT button in finish page.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="ays_exit_redirect_url"
                                            ...
                                            value="<?php echo esc_url($exit_redirect_url); ?>"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_average_statistical_option">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show average score according to all results of the quiz','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent ays-quiz-result-message-vars-parent">
                            <div class="col-sm-4">
                                <label for="ays_social_buttons">
                                    <?php echo esc_html__('Show the Social buttons','quiz-maker')?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Display social buttons for sharing quiz page URL. LinkedIn, Facebook, X, VKontakte','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-7 ays_toggle_target ays_divider_left <?php echo $enable_social_buttons ? '' : 'display_none'; ?>">
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label>
                                            <?php echo esc_html__('Heading for share buttons','quiz-maker'); ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Text that will be displayed over share buttons.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_enable_linkedin_share_button">
                                            ...
                                            <?php echo esc_html__('Enable LinkedIn button','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Display LinkedIn social button so that the users can share the page on which your quiz is posted.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_enable_facebook_share_button">
                                            ...
                                            <?php echo esc_html__('Enable Facebook button','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Display Facebook social button so that the users can share the page on which your quiz is posted.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label class="ays_quiz_enable_twitter_share_button_row" for="ays_quiz_enable_twitter_share_button">
                                            ...
                                            <span><?php echo esc_html__('Enable X button','quiz-maker'); ?></span>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Display X social button so that the users can share the page on which your quiz is posted.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_enable_vkontakte_share_button">
                                            ...
                                            <?php echo esc_html__('Enable VKontakte button','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Display VKontakte social button so that the users can share the page on which your quiz is posted.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row ays_toggle_parent ays-quiz-result-message-vars-parent">
                            <div class="col-sm-4">
                                <label for="ays_enable_social_links">
                                    <?php echo esc_html__('Enable Social Media links','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Display social media links at the end of the quiz to allow users to visit your pages in the Social media.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-7 ays_toggle_target ays_divider_left <?php echo $enable_social_links ? '' : 'display_none' ?>">
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label>
                                            <?php echo esc_html__('Heading for social media links','quiz-maker'); ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Text that will be displayed over social media links.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_linkedin_link">
                                            <i class="ays_fa ays_fa_linkedin_square"></i>
                                            <?php echo esc_html__('LinkedIn link','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('LinkedIn profile or page link for showing after quiz finish.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="ays_linkedin_link" name="ays_social_links[ays_linkedin_link]"
                                            value="<?php echo esc_url($linkedin_link); ?>" />
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_facebook_link">
                                            <i class="ays_fa ays_fa_facebook_square"></i>
                                            <?php echo esc_html__('Facebook link','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Facebook profile or page link for showing after quiz finish.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="ays_facebook_link" name="ays_social_links[ays_facebook_link]"
                                            value="<?php echo esc_url($facebook_link); ?>" />
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_twitter_link">
                                            ...
                                            <span><?php echo esc_html__('X link','quiz-maker'); ?></span>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('X profile or page link for showing after quiz finish.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_vkontakte_link">
                                            <i class="ays_fa ays_fa_vk"></i>
                                            <?php echo esc_html__('VKontakte link','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('VKontakte profile or page link for showing after quiz finish.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="ays_vkontakte_link" name="ays_social_links[ays_vkontakte_link]"
                                            value="<?php echo esc_url($vkontakte_link); ?>" />
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="instagram_link">
                                            ...
                                            <?php echo esc_html__('Instagram link','quiz-maker'); ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Instagram profile or page link for showing after quiz finish.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="youtube_link">
                                            ...
                                            <?php echo esc_html__('YouTube link','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('YouTube profile or page link for showing after quiz finish.','quiz-maker');?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="youtube_link" name="ays_social_links[ays_youtube_link]"
                                            value="<?php echo esc_url($youtube_link); ?>" />
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="behance_link">
                                            ...
                                            <?php echo esc_html__('Behance link','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Behance profile or page link for showing after quiz finish.','quiz-maker');?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="ays-text-input" id="behance_link" name="ays_social_links[ays_behance_link]"
                                            value="<?php echo esc_url($behance_link); ?>" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ays-quiz-heading-box ays-quiz-unset-float">
                            <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                <a href="https://www.youtube.com/watch?v=PQSOjFUG1Fg" target="_blank">
                                    <?php echo esc_html__("How intervals feature works - video", 'quiz-maker'); ?>
                                </a>
                            </div>
                        </div>
                        <div class="form-group row" style="margin-bottom: 0;">
                            <div class="col-sm-12 only_pro ays-quiz-margin-top-20" style="padding:15px;">
                                <div class="pro_features pro_features_popup">
                                    <div class="pro-features-popup-conteiner">
                                        <div class="pro-features-popup-title">
                                            <?php echo esc_html__("Intervals feature", 'quiz-maker'); ?>
                                        </div>
                                        <div class="pro-features-popup-content" data-link="https://youtu.be/W_H69qg3LFA">
                                            <p>
                                                <?php echo esc_html__("With the help of the Intervals feature you can display different specified results based on the Interval the user appeared in. Then, attach an image to each Interval.", 'quiz-maker'); ?>
                                            </p>
                                            <p>
                                                <?php echo wp_kses_post( sprintf( __("You can choose either %s By percentage, By Points, or By Keywords %s as a method of calculation for the Intervals.", 'quiz-maker'),
                                                    '<strong>',
                                                    '</strong>'
                                                ) ); ?>
                                            </p>
                                            <p>
                                                <?php echo esc_html__("One of the best examples of the use case of the Intervals feature is a personality quiz, where you can show different personality types to the users.", 'quiz-maker'); ?>
                                            </p>
                                            <div>
                                ...
                                <div class='form-group row ays-field-dashboard'>
                                    <div class="col-sm-4">
                                        ...
                                        <div><?php echo esc_html__("Conditional result messages", 'quiz-maker'); ?></div>
                                    </div>
                                    <div class="col-sm-8">
                                        <label class="ays_quiz_loader">
                                        ...
                                        <label class="ays_quiz_loader">
                                            ...
                                            <span><?php echo esc_html__( "By points", 'quiz-maker' ); ?></span>
                                        </label>
                                        <label class="ays_quiz_loader">
                                            <input type="radio" class="ays-enable-timer1 ays_table_by ays_intervals_display_by" tabindex="-1">
                                            <span><?php echo esc_html__( "By keywords", 'quiz-maker' ); ?></span>
                                        </label>
                                        <a class="ays_help" style="font-size:15px;" data-toggle="tooltip" data-html="true"
                                            title="<?php
                                                echo esc_html__('Choose your preferred method of calculation.','quiz-maker') .
                                                "<ul style='list-style-type: circle;padding-left: 20px;'>".
                                                    "<li>". esc_html__('By percentage - If this option is enabled, you need to assign values to Min and Max fields by percentage and write a correspondent message and attach an image for each interval separately. You need to cover the 0-100 range with as many intervals as you want.','quiz-maker') ."</li>".
                                                    "<li>". esc_html__('By points - If this option is enabled, you need to assign values to Min and Max fields by points and write a correspondent message and attach an image for each interval separately. There is no limitation to that.','quiz-maker') ."</li>".
                                                    "<li>". esc_html__('By keywords - If this option is enabled, you need to select the keywords, which you have already assigned to your answers and write a correspondent message and attach an image for each interval separately. It will be calculated based on the majority of the selected answers of the user.','quiz-maker') ."</li>".
                                                "</ul>";
                                            ?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                ...
                                <div class='ays-field-dashboard ays-table-wrap'>
                                    <table class="ays-intervals-table">
                                        <thead>
                                        <tr class="ui-state-default">
                                            <th><?php echo esc_html__('Ordering', 'quiz-maker'); ?></th>
                                            <th class="ays_interval_min_row"><?php echo esc_html__('Min', 'quiz-maker'); ?></th>
                                            <th class="ays_interval_max_row"><?php echo esc_html__('Max', 'quiz-maker'); ?></th>
                                            <th><?php echo esc_html__('Text', 'quiz-maker'); ?></th>
                                            <th><?php echo esc_html__('Image', 'quiz-maker'); ?></th>
                                            <th><?php echo esc_html__('Delete', 'quiz-maker'); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                            foreach ($quiz_intervals_default as $key => $quiz_interval) {
                                                ...
                                                <tr class="ays-interval-row ui-state-default <?php echo esc_attr($className); ?>">
                                                    ...
                                                    <td class="ays_interval_max_row">
                                                        <input type="number" tabindex="-1" value="<?php echo intval($quiz_interval['interval_max']); ?>" class="interval_max">
                                                    </td>
                                                    <td>
                        ...
                        <div class="ays-quiz-heading-box ays-quiz-unset-float ays-quiz-unset-margin">
                            <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                <a href="https://www.youtube.com/watch?v=lUbLHe9mEZ0" target="_blank">
                                    <?php echo esc_html__("How to create personality quiz - video", 'quiz-maker'); ?>
                                </a>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="ays-quiz-heading-box ays-quiz-unset-float ays-quiz-unset-margin">
                            <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                <a href="https://www.youtube.com/watch?v=BeYNME9TZsQ" target="_blank">
                                    <?php echo esc_html__("How to create WooCommerce quiz - video", 'quiz-maker'); ?>
                                </a>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 only_pro" style="padding:15px;">
                                <div class="pro_features pro_features_popup">
                                    <div class="pro-features-popup-conteiner">
                                        <div class="pro-features-popup-title">
                                            <?php echo esc_html__("Top Keywords", 'quiz-maker'); ?>
                                        </div>
                                        <div class="pro-features-popup-content" data-link="https://youtu.be/o-GB91dfsLo">
                                            <p>
                                                <?php echo esc_html__("Are you interested in showing the question results based on chosen keywords? If yes, then, you can use the Top Keywords functionality.", 'quiz-maker'); ?>
                                            </p>
                                            <p>
                                                <?php echo wp_kses_post( sprintf( __("One of the %s best use cases %s of the feature is the %s Personality Trait quiz. %s", 'quiz-maker'),
                                                    '<strong>',
                                                    '</strong>',
                                                    '<strong>',
                                                    '</strong>'
                                            ...
                                            <p>
                                                <?php echo wp_kses_post( sprintf( __("You need to configure the %s Keyword texts %s accordingly. Note: The %s Apply points to keywords %s option appears and works only in case you chose the %s By Keywords %s method of calculation.", 'quiz-maker'),
                                                    '<strong>',
                                                    '</strong>',
                                                    '<strong>',
                                                    '</strong>',
                                            ...
                                            <p>
                                                <?php echo esc_html__("By using this feature, you can display what percentage of which personality traits the particular user has.", 'quiz-maker'); ?>
                                            </p>
                                            <div>
                                                <a href="https://quiz-plugin.com/docs/" target="_blank"><?php echo esc_html__("See Documentation", 'quiz-maker'); ?></a>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="ays_enable_top_keywords">
                                                <?php echo esc_html__('Assign message to each keyword','quiz-maker'); ?>
                                                <?php echo esc_html__('(Personality Quiz)','quiz-maker'); ?>
                                                <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the question results based on keywords on the resultes page with specified texts for each keyword.','quiz-maker'); ?>">
                                                    <i class="ays_fa ays_fa_info_circle"></i>
                                                </a>
                                            </label>
                                        </div>
                        ...
                        <div class="ays-quiz-heading-box ays-quiz-unset-float" style="margin-bottom: 20px;">
                            <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                <a href="https://www.youtube.com/watch?v=LJ5X2-AMdm0" target="_blank">
                                    <?php echo esc_html__("How to Add Coupons - video", 'quiz-maker'); ?>
                                </a>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label for="ays_quiz_enable_coupon">
                                            <?php echo esc_html__('Enable quiz coupons','quiz-maker'); ?>
                                            <a class="ays_help" data-html="true" data-toggle="tooltip" title="<?php echo esc_attr__("Enable coupon receiving after finishing the quiz. For showing the coupons, you have to use the %%quiz_coupon%% message variable from General Settings>Message variables.",'quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <label for="ays_limit_users">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('This option allows to block the users who have already passed the quiz.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            <label for="ays_limitation_message">
                                                ...
                                                <a class="ays_help" data-toggle="tooltip" data-html="true" title="<?php echo esc_attr__('Limit users pass the quiz by IP or by User ID.','quiz-maker')?><br><?php echo esc_attr__('If you choose \'User ID\', the \'Limit users\' option will not work for the not logged in users. It works only with \'Only for logged in users\' option.','quiz-maker')?>">
                                                    <i class="ays_fa ays_fa_info_circle"></i>
                                                </a>
                                            </label>
                                        </div>
                                        <div class="col-sm-9">
                                            <label class="ays_quiz_loader">
                                                ...
                                                <span for="ays_limit_users_by_ip"><?php echo esc_html__('IP','quiz-maker')?></span>
                                            </label>
                                            <label class="ays_quiz_loader">
                                                ...
                                                <span for="ays_limit_users_by_user_id"><?php echo esc_html__('User ID','quiz-maker')?></span>
                                            </label>
                                            <label class="ays_quiz_loader">
                                                ...
                                                <span for="ays_limit_users_by_cookie"><?php echo esc_html__('Cookie','quiz-maker')?></span>
                                            </label>
                                            <label class="ays_quiz_loader">
                                                ...
                                                <span for="ays_limit_users_by_ip_cookie"><?php echo esc_html__('IP and Cookie','quiz-maker')?></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="position:relative;">
                                    <div class="col-sm-12 only_pro" style="padding:15px;">
                                        <div class="pro_features pro_features_popup">
                                            <div class="pro-features-popup-conteiner">
                                                <div class="pro-features-popup-title">
                                                    <?php echo esc_html__("Maximum number of attempts", 'quiz-maker'); ?>
                                                </div>
                                                <div class="pro-features-popup-content" data-link="https://youtu.be/3MboTs_CO3k">
                                                    <p>
                                                        <?php echo wp_kses_post( sprintf( __("With the help of this option you can no longer struggle with getting multiple results from the same person, which will draw a false conclusion. Restrict the attempt of the same user by just activating the %s Maximum number of attempts option. %s", 'quiz-maker'),
                                                            "<strong>",
                                                            "</strong>"
                                                        ) ); ?>
                                                    </p>
                                                    <p>
                                                        <?php echo esc_html__("This can be a useful tool for running a fair and safe examination.", 'quiz-maker'); ?>
                                                    </p>
                                                    <p>
                                                        <?php echo esc_html__("You will be able to detect uses by IP addresses, WP User IDs, Browser Cookies and by both IP addresses and Cookies. Just write the attempts count and the users will not be able to pass the quiz for more than the count that you have set.", 'quiz-maker'); ?>
                                                    </p>
                                                    <p>
                                                        <?php echo esc_html__("Write warning messages, redirect them to your desired URL and all this just in one feature.", 'quiz-maker'); ?>
                                                    </p>
                                                    <div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_quiz_max_pass_count">
                                                    <?php echo esc_html__('Attempts count:','quiz-maker')?>
                                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Specify the count of the attempts per user for passing the quiz.','quiz-maker')?>">
                                                        <i class="ays_fa ays_fa_info_circle"></i>
                                                    </a>
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_quiz_pass_score">
                                                    <?php echo esc_html__('Pass score for attempt restriction','quiz-maker')?> (%)
                                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Select the passing score(in percentage), and the attempt of the user will be detected only under that given condition. For example: If we give 40% value to it and assign 5 to the Attempts count option, the user can pass the quiz with getting more than 40% score in 5 times, but will have a chance to pass the quiz with getting under the 40% score as to how much as he/she wants.','quiz-maker')?>">
                                                        <i class="ays_fa ays_fa_info_circle"></i>
                                                    </a>
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_limit_count_by_user_role">
                                                    <?php echo esc_html__( 'Attempts count for each user role', 'quiz-maker' ); ?>
                                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Limit the count of the attempts for each user role for passing the quiz. To have this option work you need to enable Only for selected user role option.', 'quiz-maker')?>">
                                                        <i class="ays_fa ays_fa_info_circle"></i>
                                                    </a>
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group row ays-quiz-result-message-vars-parent">
                                        <div class="col-sm-3">
                                            <label for="ays_limitation_message">
                                                ...
                                                <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Message for those who have passed the quiz','quiz-maker')?>">
                                                    <i class="ays_fa ays_fa_info_circle"></i>
                                                </a>
                                            </label>
                                        </div>
                                        <div class="col-sm-9">
                                            <?php
                                            echo wp_kses($quiz_message_vars_limitation_message_html, $quiz_allowed_html);
                                            $content = (isset($options['limitation_message']) && $options['limitation_message'] != "") ? wpautop(stripslashes( $options['limitation_message'] )) : '';
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            <label for="ays_redirect_url">
                                                <?php echo esc_html__('Redirect URL','quiz-maker')?>
                                                <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('For leave current page and go to the link provided','quiz-maker')?>">
                                                    <i class="ays_fa ays_fa_info_circle"></i>
                                                </a>
                                            </label>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" name="ays_redirect_url" id="ays_redirect_url"
                                                   class="ays-text-input"
                                                   value="<?php echo (isset($options['redirect_url'])) ? esc_url($options['redirect_url']) : ''; ?>"/>
                                        </div>
                                    </div>
                                    <hr/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            <label for="ays_redirection_delay">
                                                <?php echo esc_html__('Redirect delay','quiz-maker')?>(s)
                                                <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Leave current page and go to the link provided after X second','quiz-maker')?>">
                                                    <i class="ays_fa ays_fa_info_circle"></i>
                                                </a>
                                            </label>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="number" name="ays_redirection_delay" id="ays_redirection_delay"
                                                   class="ays-text-input"
                                                   value="<?php echo (isset($options['redirection_delay'])) ? intval($options['redirection_delay']) : 0; ?>"/>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="form-group row" style="position:relative;">
                                        <div class="col-sm-12 only_pro" style="padding:15px;">
                                            <div class="pro_features pro_features_popup">
                                                <div class="pro-features-popup-conteiner">
                                                    <div class="pro-features-popup-title">
                                                        <?php echo esc_html__("Turn on extra security check", 'quiz-maker'); ?>
                                                    </div>
                                                    <div class="pro-features-popup-content" data-link="https://youtu.be/Ie0x_jP-ng8">
                                                        <p>
                                                            <?php echo wp_kses_post( sprintf( __("The %s Turn on extra security check %s option will help you to create a quiz that %s is not possible to cheat. %s", 'quiz-maker'),
                                                                "<strong>",
                                                                "</strong>",
                                                                "<strong>",
                                                                "</strong>"
                                                        ...
                                                        <p>
                                                            <?php echo esc_html__("The option works when the admin has enabled a limitation for the quiz and set the attempts count for it.", 'quiz-maker'); ?>
                                                        </p>
                                                        <p>
                                                            <?php echo esc_html__("You will be able to detect uses by IP addresses, WP User IDs, Browser Cookies and by both IP addresses and Cookies. Just write the attempts count and the users will not be able to pass the quiz for more than the count that you have set.", 'quiz-maker'); ?>
                                                        </p>
                                                        <p>
                                                            <?php echo esc_html__("If this option is enabled, and the user tries to open the quiz in more than one tab simultaneously, the quiz will not be opened.", 'quiz-maker'); ?>
                                                        </p>
                                                        <div>
                                                            <a href="https://quiz-plugin.com/docs/" target="_blank"><?php echo esc_html__("See Documentation", 'quiz-maker'); ?></a>
                                                        </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3">
                                                    <label for="ays_turn_on_extra_security_check">
                                                        <?php echo esc_html__( 'Turn on extra security check', 'quiz-maker' ); ?>
                                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('When the attempt limit of the quiz has reached, and a user tries to open your quiz in more than one tab concurrently, the results of their additional attempt will not be stored.', 'quiz-maker')?>">
                                                            <i class="ays_fa ays_fa_info_circle"></i>
                                                        </a>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3">
                                                    <label for="ays_hide_limit_attempts_notice">
                                                        <?php echo esc_html__( 'Hide attempts limitation notice', 'quiz-maker' ); ?>
                                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Hide the remaining attempts count warning when the limitation is activated.', 'quiz-maker')?>">
                                                            <i class="ays_fa ays_fa_info_circle"></i>
                                                        </a>
                                                    </label>
                                                </div>
                        ...
                        <div class="form-group row ays-quiz-result-message-vars-parent">
                            <div class="col-sm-3">
                                <label for="ays_enable_logged_users">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('After enabling this option, only logged in users will be able to pass the quiz.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <label for="ays_logged_in_message">
                                            <?php echo esc_html__('Message','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Message for those who haven’t logged in','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-9">
                                        <?php
                                        echo wp_kses($quiz_message_vars_logged_in_users_html, $quiz_allowed_html);
                                        $content = (isset($options['enable_logged_users_message']) && $options['enable_logged_users_message'] != "") ? wpautop(stripslashes( $options['enable_logged_users_message'] )) : '';
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <label for="ays_show_login_form">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Show the Login form bottom of the message for not logged in users.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group row ays-quiz-result-message-vars-parent">
                            <div class="col-sm-3">
                                <label for="ays_enable_restriction_pass">
                                    <?php echo esc_html__('Only for selected user role','quiz-maker')?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Quiz is available only for the users who have role mentioned in the list.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <label for="ays_users_roles">
                                            <?php echo esc_html__('User role','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Role of the user on the website. Option accepts multiple values.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <label for="restriction_pass_message">
                                            <?php echo esc_html__('Message','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Message for the users who aren’t included in the above-mentioned list.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-9">
                                        <?php
                                        echo wp_kses($quiz_message_vars_only_selected_user_role_html, $quiz_allowed_html);
                                        $content = (isset($options['restriction_pass_message']) && $options['restriction_pass_message'] != "") ? wpautop(stripslashes( $options['restriction_pass_message'] )) : '';
                        ...
                        <div class="form-group row ays_toggle_parent ays-quiz-result-message-vars-parent">
                            <div class="col-sm-3">
                                <label for="ays_enable_tackers_count">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('You can choose how many users can pass the quiz.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row ays_toggle_parent">
                            <div class="col-sm-3">
                                <label for="ays_enable_password">
                                    <?php echo esc_html__('Password for passing quiz', 'quiz-maker')?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('You can choose a password for users to pass the quiz.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                ...
                                                <label class="ays_quiz_loader" for="ays_generate_password_quiz">
                                                    ...
                                                    <?php echo esc_html__('Generated Passwords', 'quiz-maker') ?>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-sm-6 ays_psw_quiz_import_type_box">
                                                ...
                                                <label class="ays_quiz_loader">
                                                    <input type="radio">
                                                    <?php echo esc_html__('File upload', 'quiz-maker') ?>
                                                </label>
                                                <label class="ays_quiz_loader">
                                                    <input type="radio">
                                                    <?php echo esc_html__('Clipboard', 'quiz-maker') ?>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="ays-quiz-heading-box ays-quiz-unset-float" style="margin-bottom: 10px;">
                                    <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                        <a href="https://www.youtube.com/watch?v=BMmQbafdzR8" target="_blank">
                                            <?php echo esc_html__("How to create Password-Protected Quiz - video", 'quiz-maker'); ?>
                                        </a>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        <label for="ays_password_quiz">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Password for users who can pass the quiz.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-10">
                                        <input type="text" name="ays_password_quiz" id="ays_password_quiz" class="ays-enable-timer ays-text-input" value="<?php echo esc_attr($password_quiz); ?>">
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="ays_quiz_password_width" id="ays_quiz_password_width" class="ays-enable-timer ays-text-input" value="<?php echo esc_attr($quiz_password_width); ?>">
                                        <span style="display:block;" class="ays_quiz_small_hint_text"><?php echo esc_html__("For 100% leave blank", 'quiz-maker'); ?></span>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        <label for="ays_quiz_enable_password_visibility">
                                            ...
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Tick the option, and it will let you enable and disable password visibility in a password input field.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row ays-quiz-result-message-vars-parent">
                                    <div class="col-sm-2">
                                        <label for="ays_quiz_password_message">
                                            <?php echo esc_html__('Message','quiz-maker'); ?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Users will see this message before entering the password for passing the quiz.','quiz-maker'); ?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-10">
                                        <?php
                                        echo wp_kses($quiz_message_vars_password_for_passing_quiz_html, $quiz_allowed_html);
                                ...
                                <div class="form-group row ays_toggle_parent">
                                    <div class="col-sm-3">
                                        <label for="ays_enable_restriction_pass_users">
                                            <?php echo esc_html__('Access only selected users','quiz-maker')?>
                                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Quiz is available only for the users mentioned in the list.','quiz-maker')?>">
                                                <i class="ays_fa ays_fa_info_circle"></i>
                                            </a>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-sm-8 ays_toggle_target ays_divider_left">
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                <label for="ays_users_roles">
                                                    <?php echo esc_html__('Users','quiz-maker')?>
                                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Users on the website.','quiz-maker')?>">
                                                        <i class="ays_fa ays_fa_info_circle"></i>
                                                    </a>
                                                </label>
                                            </div>
            ...
            <div id="tab6" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab6') ? 'ays-quiz-tab-content-active' : ''; ?>">
                ...
                <div class="ays-quiz-accordion-options-main-container" data-collapsed="false">
                    <div class="ays-quiz-accordion-container">
                        <?php echo wp_kses($quiz_accordion_svg_html, $quiz_allowed_html); ?>
                        <p class="ays-subtitle"><?php echo esc_html__('User Information','quiz-maker')?></p>
                    </div>
                    <hr class="ays-quiz-bolder-hr"/>
                    <div class="ays-quiz-accordion-options-box">
                        <div class="form-group row ays-quiz-result-message-vars-parent">
                            <div class="col-sm-4">
                                <label for="ays_form_title">
                                    <?php echo esc_html__('Information Form title','quiz-maker'); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Description of the Information Form which will be shown at the top of the Form Fields.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-8" style="border-left: 1px solid #ccc">
                                <?php
                                echo wp_kses($quiz_message_vars_information_form_html, $quiz_allowed_html);
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <label for="ays_information_form">
                                    <?php echo esc_html__('Information form','quiz-maker')?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Data form for the user personal information. You can choose when the Information Form will be shown for completion.','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            ...
                            <div class="col-sm-8" style="border-left: 1px solid #ccc">
                                <div class="information_form_options" <?php echo (!isset($options['information_form']) || $options['information_form'] == "disable") ? 'style="display:none"' : ''; ?>>
                                    <p class="ays_required_field_title"><?php echo esc_html__('Form Fields','quiz-maker')?></p>
                                    <hr>
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="ays_form_name"><?php echo esc_html__('Name','quiz-maker')?></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="ays_form_email"><?php echo esc_html__('Email','quiz-maker'); ?></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="ays_form_phone"><?php echo esc_html__('Phone','quiz-maker'); ?></label>
                                    </div>
                                    <hr>
                                    <p class="ays_required_field_title"><?php echo esc_html__('Required Fields','quiz-maker'); ?></p>
                                    <hr>
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="ays_form_name_required"><?php echo esc_html__('Name','quiz-maker'); ?></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="ays_form_email_required"><?php echo esc_html__('Email','quiz-maker')?></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="ays_form_phone_required"><?php echo esc_html__('Phone','quiz-maker')?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_show_information_form">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Enable the option if you want to show the Information Form to logged-in users as well. If the option is disabled, then logged-in users will not see the Information Form before or after the quiz, but the system will collect the Name and Email info from their WP accounts and store in the Name and Email fields in the database.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_autofill_user_data">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('After enabling this option, logged in  user’s name and email will be autofilled in Information Form.','quiz-maker'); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row only_pro" style="position:relative;padding:15px;">
                            <div class="pro_features pro_features_popup">
                                <div class="pro-features-popup-conteiner">
                                    ...
                                    <div class="pro-features-popup-content" data-link="https://youtu.be/SEv7ZY7idtE">
                                        <p>
                                            <?php echo wp_kses_post( sprintf( __("Custom Fields will allow you to create various fields with %s 8 available field types, %s including text, number, telephone. With just two simple steps, you can get any information you wish from the Quiz takers and add  %s GDPR %s checkbox as well. Get personal data, such as gender, country, age etc.", 'quiz-maker'),
                                                "<strong>",
                                                "</strong>",
                                                "<strong>",
                                                "</strong>"
                            ...
                            <div class="col-sm-4">
                                <label>
                                    <?php echo esc_html__('Add custom fields','quiz-maker'); ?>
                                    <a class="ays_help" tabindex="-1" data-toggle="tooltip" title="<?php echo esc_attr__('You can add form custom fields from “Custom fields” page in Quiz Maker menu.  (text, textarea, checkbox, select, URL etc.)','quiz-maker')?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-8 ays_divider_left">
                                <blockquote>
                                    <?php echo esc_html__("For creating custom fields click", 'quiz-maker'); ?>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 only_pro">
                                <div class="pro_features pro_features_popup">
                                    <div class="pro-features-popup-conteiner">
                                        <div class="pro-features-popup-title">
                                            <?php echo esc_html__("Send email to admin", 'quiz-maker'); ?>
                                        </div>
                                        <div class="pro-features-popup-content" data-link="https://youtu.be/YUGTj9zJVeE">
                                            <p>
                                                <?php echo wp_kses_post( sprintf( __("The Quiz Maker plugin gives the opportunity not only to send the email to the users after the quiz completion but also to %s the admin. %s", 'quiz-maker'),
                                                    "<strong>",
                                                    "</strong>"
                                                ) ); ?>
                                            </p>
                                            <p>
                                                <?php echo wp_kses_post( sprintf( __("By enabling this option, you can send a %s Certificate and results report %s to the admin. You can set a passing score so that the admin can receive the email only if the user has passed the minimum required score.", 'quiz-maker'),
                                                    "<strong>",
                                                    "</strong>"
                                                ) ); ?>
                                            </p>
                                            <p>
                                                <?php echo wp_kses_post( sprintf( __("Also, you can %s fully customize %s the Email Message option, by inserting your desired %s message variables %s in the WP Editor from the %s General Settings %s page.", 'quiz-maker'),
                                                    "<strong>",
                                                    "</strong>",
                                                    "<strong>",
                                                    "</strong>",
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <label class="ays-disable-setting"><?php echo esc_html__('Send Mail To Admin','quiz-maker'); ?></label>
                                    </div>
                                    <div class="col-sm-1">
                                    ...
                                    <div class="col-sm-8 ays_divider_left">
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_enable_send_mail_to_admin_by_pass_score">
                                                    <?php echo esc_html__('Pass score (%)', 'quiz-maker'); ?>
                                                    <a  class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('If the option is enabled, then the admin will receive the email only if the user has passed the minimum score required. It will take the value of the general pass score of the quiz. Please specify it in the Result Settings tab.','quiz-maker'); ?>">
                                                        <i class=""></i>
                                                    </a>
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <blockquote><?php echo esc_html__( 'Tick the checkbox, and admin will receive the email only if the user has passed the minimum score required.', 'quiz-maker' ); ?></blockquote>
                                            </div>
                                        </div>
                                        <hr>
                                        <!-- ................ -->
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_send_mail_to_site_admin">
                                                    <?php echo esc_html__('Admin', 'quiz-maker')?>
                                                    <a  class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Disable this feature, if you want to make it possible not to send emails to the registered Mail of the site Admin, but only to additional emails.','quiz-maker')?>">
                                                    </a>
                                                </label>
                                            </div>
                                            <div class="col-sm-1">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_additional_emails">
                                                    <?php echo esc_html__('Additional Emails','quiz-maker'); ?>
                                                </label>
                                            </div>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5">
                                                <label for="ays_send_results_admin">
                                                    <?php echo esc_html__('Send Report table to Admin','quiz-maker')?>
                                                    <a  class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('You can send results to the admin after the quiz is completed','quiz-maker')?>">
                                                    </a>
                                                </label>
                                            </div>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5">
                                                <label for="ays_send_interval_msg_to_admin">
                                                    <?php echo esc_html__('Send Interval message to Admin','quiz-maker')?>
                                                    <a  class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('If this option is enabled then the admin will get the Email with Interval message.','quiz-maker')?>">
                                                    </a>
                                                </label>
                                            </div>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5">
                                                <label for="ays_send_certificate_to_admin">
                                                    <?php echo esc_html__('Send Certificate to Admin too','quiz-maker')?>
                                                    <a  class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('If this option is enabled then the admin will get the Email with an attached PDF file that gets the user. If the "Send Certificate To User" option is disabled admin does not get a certificate too.','quiz-maker'); ?>">
                                                    </a>
                                                </label>
                                            </div>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_mail_message_admin">
                                                    <?php echo esc_html__('Mail message','quiz-maker')?>
                                                    <a  class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Provide the message text for sending to the Admin by email. You can use Variables from General Settings page to insert data. (name, score, date etc.)','quiz-maker')?>">
                                                    </a>
                                                </label>
                                            </div>
                                            <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label>
                                            <?php echo esc_html__('Email Configuration','quiz-maker'); ?>
                                        </label>
                                    </div>
                                    <div class="col-sm-8 ays_divider_left">
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_email_configuration_from_email">
                                                    <?php echo esc_html__('From Email','quiz-maker'); ?>
                                                </label>
                                            </div>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_email_configuration_from_name">
                                                    <?php echo esc_html__('From Name','quiz-maker'); ?>
                                                </label>
                                            </div>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="ays_email_configuration_from_subject">
                                                    <?php echo esc_html__('From Subject','quiz-maker'); ?>
                                                </label>
                                            </div>
                                            <div class="col-sm-9">
            ...
            <div id="tab9" class="ays-quiz-publish-tab-content ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab9') ? 'ays-quiz-tab-content-active' : ''; ?>">
                <div class="form-group row" style="justify-content: center">
                    <div class="col-sm-12 ays-quiz-options-tab-content-max-width">
                        <div class="ays-quiz-publish-container">
                            
                            <!-- Header -->
                            <div class="ays-quiz-publish-header">
                                <h2 class="ays-quiz-publish-title"><?php echo esc_html__('Publish Your Quiz', 'quiz-maker'); ?></h2>
                                <p class="ays-quiz-publish-subtitle"><?php echo esc_html__("Learn how to add this quiz to your site, depending on the editor you're using.", 'quiz-maker'); ?></p>
                            </div>
                            
                            <?php if( 1 == 0 ): ?>
                            <!-- Info Cards -->
                            <div class="ays-quiz-info-cards">
                                <div class="ays-quiz-info-card">
                                    <div>
                                        <p class="ays-quiz-info-card-text">
                                            <?php
                                            echo wp_kses(
                                                sprintf(
                                                    /* translators: 1: Opening <strong> tag, 2: Closing </strong> tag */
                                                    esc_html__( 'View how %1$sthis quiz%2$s appears on the frontend', 'quiz-maker' ),
                                                    '<strong>',
                                                    '</strong>'
                                                ),
                                                array(
                                        ...
                                        <?php if(empty($quiz_preview_url)): ?>
                                            <p class="ays-quiz-info-card-hint">
                                                <a href="#" class="ays-quiz-save-publish-link">
                                                    <?php echo esc_html__('Save the quiz first to enable preview', 'quiz-maker'); ?>
                                                </a>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <?php if(!empty($quiz_preview_url)): ?>
                                        <a href="<?php echo esc_url($quiz_preview_url); ?>" target="_blank" class="ays-quiz-info-card-link"><?php echo esc_html__('View Quiz', 'quiz-maker'); ?></a>
                                    <?php else: ?>
                                        <span class="ays-quiz-info-card-link ays-quiz-info-card-link-disabled">
                                            <?php echo esc_html__('View Quiz', 'quiz-maker'); ?>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <!-- Steps Card -->
                            <div class="ays-quiz-steps-card">
                                <h3 class="ays-quiz-steps-card-title"><?php echo esc_html__('Quiz Display', 'quiz-maker'); ?></h3>

                                <div class="ays-quiz-grid-view-summary">
                                    <p class="ays-quiz-info-card-text">
                                        <?php
                                        echo wp_kses(
                                            sprintf(
                                ...
                                <h4 class="ays-quiz-steps-card-title ays-quiz-steps-card-title-center"><?php echo esc_html__('How to Add This Quiz to Your Site (3 Options)', 'quiz-maker'); ?></h4>
                                
                                <!-- Step 1: Gutenberg -->
                                <div class="ays-quiz-step-block">
                                    <div class="ays-quiz-step-header">
                                        <div class="ays-quiz-step-number-badge"></div>
                                        <h3 class="ays-quiz-step-title"><?php echo esc_html__('Using Gutenberg Editor', 'quiz-maker'); ?></h3>
                                    </div>
                                    <div class="ays-quiz-step-instructions">
                                        <ol class="ays-quiz-step-list">
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Click Add Block (+) and select the Quiz Maker block.', 'quiz-maker'); ?></li>
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Place the block where you want the quiz to appear.', 'quiz-maker'); ?></li>
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Choose the needed quiz from the block dropdown.', 'quiz-maker'); ?></li>
                                        </ol>
                                    </div>
                                </div>

                                <hr class="ays-quiz-step-divider">

                                <!-- Step 2: Elementor -->
                                <div class="ays-quiz-step-block">
                                    <div class="ays-quiz-step-header">
                                        <div class="ays-quiz-step-number-badge"></div>
                                        <h3 class="ays-quiz-step-title"><?php echo esc_html__('Using Elementor', 'quiz-maker'); ?></h3>
                                    </div>
                                    <div class="ays-quiz-step-instructions">
                                        <ol class="ays-quiz-step-list">
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Find the Quiz Maker widget in Elementor widgets.', 'quiz-maker'); ?></li>
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Drag and drop it where you want the quiz to appear.', 'quiz-maker'); ?></li>
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Select the quiz from the widget settings.', 'quiz-maker'); ?></li>
                                        </ol>
                                    </div>
                                </div>
                                ...
                                <div class="ays-quiz-step-block">
                                    <div class="ays-quiz-step-header">
                                        <div class="ays-quiz-step-number-badge"></div>
                                        <h3 class="ays-quiz-step-title"><?php echo esc_html__('Using Classic Editor', 'quiz-maker'); ?></h3>
                                    </div>
                                    <div class="ays-quiz-step-instructions">
                                        <p class="ays-quiz-step-note"><?php echo esc_html__("The Classic Editor doesn't support Gutenberg blocks directly. In this case, use the quiz shortcode.", 'quiz-maker'); ?></p>
                                        <ol class="ays-quiz-step-list">
                                            <li class="ays-quiz-step-list-item">
                                                <?php echo esc_html__('Copy this quiz shortcode:', 'quiz-maker'); ?>
                                            </li>

                                            <li class="ays-quiz-step-list-item ays-quiz-shortcode-container">
                                                <?php if(!empty($quiz_shortcode)): ?>
                                                    <code class="ays-quiz-shortcode-text"><?php echo esc_html($quiz_shortcode); ?></code>
                                                ...
                                                <?php else: ?>
                                                    <a href="#" class="ays-quiz-save-publish-link">
                                                        <?php echo esc_html__('Save the quiz to generate its shortcode', 'quiz-maker'); ?>
                                                    </a>
                                                <?php endif; ?>
                                            </li>
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Open the post or page where you want to display the quiz in Classic Editor.', 'quiz-maker'); ?></li>
                                            <li class="ays-quiz-step-list-item"><?php echo esc_html__('Paste the shortcode in the editor. Make sure to check whether the Code option is selected.', 'quiz-maker'); ?></li>
            ...
            <div class="ays-modal-content">
                <form method="post" id="ays_add_question_rows">
                    <div class="ays-quiz-preloader">
                        <img loading="lazy" class="ays-quiz-preloader-image" src="<?php echo esc_url( AYS_QUIZ_ADMIN_URL . '/images/loaders/cogs.svg' ); ?>">
                    </div>
                    ...
                    <div class="ays-modal-body">
                        ...
                        <div class="ays-quiz-add-question-filter-box">
                            <div class="ays-quiz-add-question-filter" id="ays-quiz-add-question-filter">
                                <img loading="lazy" src="<?php echo esc_url( AYS_QUIZ_ADMIN_URL . '/images/icons/filter.svg' ); ?>" style="width: 20px;">
                            ...
                            <div class="ays-quiz-insert-question-modal-create-link" style="font-size: 16px; padding-right:20px; margin:0; text-align:right;">
                                <a class="" href="admin.php?page=<?php echo esc_attr($this->plugin_name); ?>-questions&action=add" target="_blank">
                                    <?php echo esc_html__('Create question', 'quiz-maker'); ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-external-link-icon lucide-external-link"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg>
                                </a>
                            </div>
                                ...
                                <div class="row" style="margin:0;">
                                    <div class="col-sm-12" id="quest_tag_container">
                                        <label style="width:100%;" for="add_quest_tag_filter">
                                            <p style="font-size: 13px; margin:0; font-style: italic;">
                                                <?php echo esc_html__( "Filter by tag", 'quiz-maker'); ?>
                        ...
                        <table class="ays-add-questions-table hover order-column" id="ays-question-table-add" data-page-length='5'>
                            ...
                            foreach ($questions as $index => $question) {
                                ...
                                if(Quiz_Maker_Admin::validateDate($date)){
                                    $text .= "<p style='margin:0;text-align:left;'><b>Date:</b> ". esc_html( $date ) ."</p>";
                                }
                                if($author['name'] !== "Unknown"){
                                    $text .= "<p style='margin:0;text-align:left;'><b>Author:</b> ". esc_html($author['name']) ."</p>";
                                }
                    ...
                    <div id="ays-quiz-all-pages-popup-heading">
                        <div class="ays-quiz-all-pages-popup-heading-center">
                            <a href="http://bit.ly/3HsHaML" target="_blank">
                                <img loading="lazy" src="<?php echo esc_url( AYS_QUIZ_ADMIN_URL . '/images/quiz-maker-and-chart-logo.svg' ); ?>">
                            </a>
                        </div>
                    </div>
                    <div id="ays-quiz-all-pages-popup-content">
                        <div class="ays-quiz-all-pages-popup-content-title"><?php echo esc_html__("New Integration", 'quiz-maker'); ?></div>
                        <div class="ays-quiz-all-pages-popup-content-description"><?php echo esc_html__("Visualize your data with a Chart Builder", 'quiz-maker'); ?></div>
                    </div>
                    <div class="ays-quiz-all-pages-popup-footer">
                        <div id="ays-quiz-all-pages-popup-button" class="ays-quiz-all-pages-popup-st">
                            <div class="ays-quiz-all-pages-popup-btn">
                                <a href="http://bit.ly/3HsHaML" id="ays-pages-submit-popup" class="ays-quiz-all-pages-popup-fields ays-quiz-all-pages-popup-fields-submit" target="_blank"><?php echo esc_html__("Try For Free", 'quiz-maker'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="ays-quiz-fox-lms-all-pages-popup-main">
                <div class="ays-quiz-fox-lms-all-pages-popup-layer">
                    ...
                    <div id="ays-quiz-fox-lms-all-pages-popup-heading">
                        <div class="ays-quiz-fox-lms-all-pages-popup-heading-center">
                            <a href="https://bit.ly/43MyeyB" target="_blank">
                                <img loading="lazy" src="<?php echo esc_url( AYS_QUIZ_ADMIN_URL . '/images/banner/ays-quiz-and-lms-popup-logo.svg' ); ?>">
                                <img loading="lazy" class="ays-quiz-fox-lms-all-pages-icon" src="<?php echo esc_url( AYS_QUIZ_ADMIN_URL . '/images/banner/ays-quiz-and-lms-popup-icon.svg' ); ?>">
                            </a>
                        </div>
                    </div>
